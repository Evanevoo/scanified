...
const sidebarPages = [
  ...
  { label: 'Scanned Orders', icon: <AssignmentIcon />, to: '/scanned-orders' },
  {
    label: 'Integrations', icon: <SwapVertIcon />, to: null, subItems: [
      ...
      { label: 'Integrations Home', to: '/integrations' },
    ]
  },
];
...
export default function MainLayout() {
  ...
  const drawer = (
    <Box sx={{ bgcolor: '#fff', height: '100%', display: 'flex', flexDirection: 'column', borderRight: '1.5px solid #eaeaea', minHeight: '100vh', width: drawerWidth, position: 'relative' }}>
      ...
      >
        <Toolbar sx={{ minHeight: 64, px: 3 }}>
          <Typography
            variant="h5"
            component="div"
            sx={{ fontFamily: 'Inter, Montserrat, Arial, sans-serif', fontWeight: 900, color: '#111', letterSpacing: '-0.01em', fontSize: '1.6rem', mr: 3 }}
          >
            LessAnnoyingScan
          </Typography>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', ml: 4 }}>
            ...
            <IconButton sx={{ color: '#111', ml: 1 }} onClick={() => {/* TODO: Add logout logic */}} aria-label="Logout">
              <LogoutIcon />
            </IconButton>
          </Box>
        </Toolbar>
