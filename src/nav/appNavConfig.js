...
export const APP_NAV_ROUTE_ENTRIES = [
  ...
  {
    path: '/import-rental-agreements',
    title: 'Import lease agreements',
    subtitle: 'TrackAbout-style rental / lease CSV',
    keywords: ['trackabout', 'lease', 'rental', 'csv'],
  },
  ...
  {
    path: '/inventory/asset-classifications',
    title: 'Asset Classifications',
    subtitle: 'TrackAbout-style product tree',
    keywords: ['trackabout', 'taxonomy', 'categories', 'product tree', 'argon', 'oxygen'],
  },
  {
    path: '/inventory/asset-classifications/pricing',
    title: 'Classification tree rates',
    subtitle: 'Default pricing by asset tree branch',
    keywords: ['pricing', 'rates', 'monthly', 'yearly', 'classification', 'asset type'],
  },
