...
const BenefitItem = ({ text, index, reduceMotion }) => {
  const ref = useRef(null);
...
export default function ModernLandingPage() {
  ...
  const features = [
    {
      ...
      description: `See where every ${assetConfig.assetTypeSingular || 'asset'} is across depots and customer sites with scanning, routing, and location-aware workflows.`
    },
    {
  ...
  const benefits = [
    `Improve visibility and accountability for every ${assetConfig.assetTypePlural || 'asset'} with scanning and audit trails`,
    ...
    "Access data from anywhere with a cloud-based platform",
    "Integrate with accounting and operations tools—exports today, deeper integrations on request"
  ];
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-black">{assetConfig.appName || 'Scanified'}</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-700 hover:text-black transition-colors" onClick={(e) => { e.preventDefault(); navigate('/contact'); }}>Careers</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-700 hover:text-black transition-colors" onClick={(e) => { e.preventDefault(); navigate('/privacy-policy#cookies'); }}>Cookie policy</a></li>
                <li><a href="#" className="text-sm text-gray-700 hover:text-black transition-colors" onClick={(e) => { e.preventDefault(); navigate('/privacy-policy#data-rights'); }}>Your data rights</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="pt-8 border-t-2 border-black">
            <p className="text-center text-sm text-gray-700">
              © {new Date().getFullYear()} {assetConfig.appName || 'Scanified'}. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
