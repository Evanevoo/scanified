...
export default function CustomerDetailsScreen() {
  ...
  useEffect(() => {
    ...
    const fetchDetails = async () => {
      ...
      // Fetch customer info for the current organization (try CustomerListID first, then fall back to UUID)
  ...
  return (
    ...
    >
      {/* Header card with customer name */}
      <MobileCard elevated intensity="medium" style={styles.headerCard}>
      ...
      <MobileCard elevated={false} style={styles.infoCard}>
      ...
      {cylinders.length === 0 ? (
        <MobileCard elevated={false} style={styles.emptyCard}>
