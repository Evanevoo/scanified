-- Truck Reconciliation Database Setup
...
DROP POLICY IF EXISTS "Admins can manage delivery stops" 
...
DROP POLICY IF EXISTS "Admins can manage delivery manifests" 
...
DROP POLICY IF EXISTS "Admins can manage manifest items" 
...
DROP POLICY IF EXISTS "Admins can manage truck reconciliations" 
...
DROP POLICY IF EXISTS "Admins can manage reconciliation discrepancies" 
