...
export default function SettingsScreen() {
  ...
  const handleAutoSyncToggle = useCallback(async (value: boolean) => {
    try {
      ...
      // #region agent log
      fetch('http://127.0.0.1:7716/ingest/af979272-15bb-4603-9fe5-a14af47582a2',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'c23505'},body:JSON.stringify({sessionId:'c23505',runId:'settings-toggle-pre-fix',hypothesisId:'H1',location:'gas-cylinder-mobile/screens/SettingsScreen.tsx:128',message:'Auto sync toggle invoked',data:{value,hasSendSyncNotification:typeof (notificationService as any).sendSyncNotification === 'function'},timestamp:Date.now()})}).catch(()=>{});
      // #endregion
      ...
      // #region agent log
      fetch('http://127.0.0.1:7716/ingest/af979272-15bb-4603-9fe5-a14af47582a2',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'c23505'},body:JSON.stringify({sessionId:'c23505',runId:'settings-toggle-pre-fix',hypothesisId:'H1',location:'gas-cylinder-mobile/screens/SettingsScreen.tsx:128',message:'Auto sync toggle failed',data:{value,errorName:error?.name || null,errorMessage:error?.message || String(error)},timestamp:Date.now()})}).catch(()=>{});
      // #endregion
      throw error;
    }
  }, [updateSetting]);
  ...
  const handleOfflineModeToggle = useCallback(async (value: boolean) => {
    try {
      ...
      // #region agent log
      fetch('http://127.0.0.1:7716/ingest/af979272-15bb-4603-9fe5-a14af47582a2',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'c23505'},body:JSON.stringify({sessionId:'c23505',runId:'settings-toggle-pre-fix',hypothesisId:'H2',location:'gas-cylinder-mobile/screens/SettingsScreen.tsx:139',message:'Offline mode toggle invoked',data:{value,hasSetOfflineMode:typeof (offlineModeService as any).setOfflineMode === 'function',hasSendOfflineModeNotification:typeof (notificationService as any).sendOfflineModeNotification === 'function'},timestamp:Date.now()})}).catch(()=>{});
      // #endregion
      ...
      // #region agent log
      fetch('http://127.0.0.1:7716/ingest/af979272-15bb-4603-9fe5-a14af47582a2',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'c23505'},body:JSON.stringify({sessionId:'c23505',runId:'settings-toggle-pre-fix',hypothesisId:'H2',location:'gas-cylinder-mobile/screens/SettingsScreen.tsx:139',message:'Offline mode toggle failed',data:{value,errorName:error?.name || null,errorMessage:error?.message || String(error)},timestamp:Date.now()})}).catch(()=>{});
      // #endregion
      throw error;
    }
  }, [updateSetting]);
