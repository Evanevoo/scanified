-- Apply Email Uniqueness and Organization Invite System
-- Run this script in your Supabase SQL editor

-- 1. Add email uniqueness constraint to profiles table
DO $$ 
BEGIN
...
-- 2. Create organization invites table for secure user registration
...
-- 4. Add RLS policies for organization_invites
...
-- 5. Add function to generate invite tokens
...
-- 6. Add function to create organization invite
...
-- 7. Add function to accept organization invite
